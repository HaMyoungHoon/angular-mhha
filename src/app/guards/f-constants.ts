...
export const ETC_MQTT_TEST_URL = "etc/mqtt-test";
...
export function googleDarkTheme(): any {
  return [
    {
...
export function googleRetroTheme(): any {
  return [
    {
      "elementType": "geometry",
      "stylers": [
...
export function googleNightTheme(): any {
  return [
    {
      "elementType": "geometry",
      "stylers": [
...
export function googleAubergineTheme(): any {
  return [
    {
      "elementType": "geometry",
      "stylers": [
